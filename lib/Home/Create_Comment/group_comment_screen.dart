...
class GroupComment extends StatefulWidget {
  ...
  GroupComment(this.groupID, this.postId,{Key key}) : super(key: key);
  @override
...
class _GroupCommentState extends State<GroupComment> {
  ...
  void _groupUpdateComment(context, String postId, String commentId) {
    showModalBottomSheet(

      context: context,
      builder: (BuildContext builder) {
        return
          GroupUpdateComment(widget.groupID, widget.postId,commentId);
