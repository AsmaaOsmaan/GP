...
import 'package:flutter_shop/Home/Edit_Comment/page_edit_comment.dart';
...
class PageComment extends StatefulWidget {
  ...
  PageComment(this.pageID, this.postId,{Key key}) : super(key: key);
  @override
...
class _PageCommentState extends State<PageComment> {
  ...
  void _pageUpdateComment(context, String postId, String commentId) {
    showModalBottomSheet(

      context: context,
      builder: (BuildContext builder) {
        return
          PageUpdateComment(widget.pageID, widget.postId,commentId);
