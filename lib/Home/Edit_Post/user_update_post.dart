...
class UserUpdatePost extends StatefulWidget {
  final String documentID;
  final String postId;

  UserUpdatePost(this.documentID, this.postId, {Key key}) : super(key: key);
  @override
  _UserUpdatePostState createState() => _UserUpdatePostState();
}

class _UserUpdatePostState extends State<UserUpdatePost> {
