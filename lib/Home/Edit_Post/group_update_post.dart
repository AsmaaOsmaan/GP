...
class GroupUpdatePost extends StatefulWidget {
  final String groupId;
  final String postId;

  GroupUpdatePost(this.groupId, this.postId, {Key key}) : super(key: key);
  @override
  _GroupUpdatePostState createState() => _GroupUpdatePostState();
}

class _GroupUpdatePostState extends State<GroupUpdatePost> {
