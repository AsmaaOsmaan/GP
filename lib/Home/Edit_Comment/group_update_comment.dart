...
class GroupUpdateComment extends StatefulWidget {
  final String groupID;
  final String postId;
  final String commentId;
  GroupUpdateComment(this.groupID, this.postId,this.commentId, {Key key}) : super(key: key);
  @override
  _GroupUpdateCommentState createState() => _GroupUpdateCommentState();
}

class _GroupUpdateCommentState extends State<GroupUpdateComment> {
