...
class pageComment extends StatefulWidget {
  ...
  pageComment(this.documentID, this.postId, {Key key}) : super(key: key);
  @override
  ...
  void _updateComment(context, String postId, String commentId) {
    showModalBottomSheet(
      ...
      builder: (BuildContext builder) {
        return UpdateComment(widget.documentID, widget.postId, commentId);
      },
                  ...
                  onPressed: () async {
                    if (_commentController.currentState.value
                      ...
                      Firestore.instance
                          ...
                          .collection('comment')
                          .add({
                        'commentData': _commentController.currentState.value,
