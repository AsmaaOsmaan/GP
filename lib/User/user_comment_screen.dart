...
import 'package:flutter_shop/Home/Edit_Comment/user_update_comment.dart';
import 'package:flutter_shop/Home/Edit_Comment/group_update_comment.dart';
...
class UserComment extends StatefulWidget {
  ...
  UserComment( this.postId,{Key key}) : super(key: key);
  @override
...
class _UserCommentState extends State<UserComment> {
  ...
  void _UserupdateComment(context, String postId, String commentId) {
    showModalBottomSheet(
      ...
      builder: (BuildContext builder) {
        ...
        return
          UserUpdateComment(auth.userData.id, widget.postId,commentId);
                    ...
                    if (_commentController.currentState.value
                      ...
                      Firestore.instance.collection('user_home')
                          ...
                          .collection('post').document(widget.postId).get().then(
                              (DocumentSnapshot result) async {
                                if (result["userid"]!=auth.userData.id){
