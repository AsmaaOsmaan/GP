...
class tryGroups extends StatefulWidget {

  @override
  _tryGroupsState createState() => _tryGroupsState();
}

class _tryGroupsState extends State<tryGroups> {
