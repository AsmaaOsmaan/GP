...
//import 'package:flutter_shop/Screenss/user_comment_screen.dart';
...
class AddFriend extends StatefulWidget {
  ...
  AddFriend(this.documentID ,{Key key}) : super(key: key);
  @override
  ...
  void _UserEditPost(context, String postId) {
    ...
    showModalBottomSheet(
      ...
      builder: (BuildContext builder) {
        return UserUpdatePost(user.id, postId);
      },
                              ...
                              onPressed: () async{
                                ...
                                if (pressed) {
                                  ...
                                  Firestore.instance
                                    ...
                                    'timestamp': Timestamp.fromDate(DateTime.now()),
                                    'type':'sendRequest',
                                    'friend_name':snapshot.data['UserName'],
